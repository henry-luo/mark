...
You can refer to the [syntax spec](syntax.md) for details.
...
You can refer to the [data model spec](data-model.md) for details.
...
- Mark incorporates some syntax enhancements to JSON, thus making the format more friendly for humans.
