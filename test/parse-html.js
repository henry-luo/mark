...
test('Parse HTML', function(assert) {
	...
	assert.equal(obj.toHtml(), '<!DOCTYPE html><html lang="en"><!-- comment --><head></head><body width="100%"><p class="main"><span title="Good &amp; bad">hello</span> world</p><br></body></html>', 'Parse and toHtml()'),
