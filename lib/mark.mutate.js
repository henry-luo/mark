let MarkMutate = function(Mark, pushFunc, lenSymbol, pragSymbol) {
	...
	Object.defineProperty(Object.getPrototypeOf(Mark.pragma()), 'set', {value:function(value) { this[pragSymbol] = value;  return this; }});
};
